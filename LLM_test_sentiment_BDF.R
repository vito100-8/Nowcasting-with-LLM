...
dates <- dates2 # avec les dates sans EMC BdF
...
for (dt in as.Date(dates$`Date Prevision`)) {
  ...
  all_docs_to_combine <- c(pdf_path)
...
# Enregistrement
write.xlsx(df_indice, file = "Results/BDF_sentiment.xlsx", sheetName = "prevision", rowNames = FALSE)
print("Enregistré: Results_sentiment.xlsx \n")
