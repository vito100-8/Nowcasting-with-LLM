...
write.xlsx(df_final_BDF,
  file = "Final_Results/BDF_noText_2020.xlsx",
  sheetName = "prevision", rowNames = FALSE
)

write.xlsx(df_final_INSEE,
  file = "Final_Results/INSEE_noText_2020.xlsx",
  sheetName = "prevision", rowNames = FALSE
)
...
write.xlsx(df_final_BDF,
  file = "Final_Results/BDF_text_2020.xlsx",
  sheetName = "prevision", rowNames = FALSE
) # 3

write.xlsx(df_final_INSEE,
  file = "Final_Results/INSEE_Text_2020.xlsx",
  sheetName = "prevision", rowNames = FALSE
) # 4
...
write.xlsx(df_final_BDF,
  file = "Final_Results/BDF_text_FR_2020.xlsx",
  sheetName = "prevision", rowNames = FALSE
) # 3

write.xlsx(df_final_INSEE,
  file = "Final_Results/INSEE_Text_FR_2020.xlsx",
  sheetName = "prevision", rowNames = FALSE
) # 4
...
write.xlsx(df_final_BDF,
  file = "Final_Results/BDF_excel_2020.xlsx",
  sheetName = "prevision", rowNames = FALSE
) # 3

write.xlsx(df_final_INSEE,
  file = "Final_Results/INSEE_excel_2020.xlsx",
  sheetName = "prevision", rowNames = FALSE
) # 4
...
write.xlsx(df_final_BDF,
  file = "Final_Results/BDF_all_2020.xlsx",
  sheetName = "prevision", rowNames = FALSE
) # 3

write.xlsx(df_final_INSEE,
  file = "Final_Results/INSEE_all_2020.xlsx",
  sheetName = "prevision", rowNames = FALSE
) # 4
...
write.xlsx(df_final_BDF,
  file = "Final_Results/BDF_just_text_2020.xlsx",
  sheetName = "prevision", rowNames = FALSE
) # 3

write.xlsx(df_final_INSEE,
  file = "Final_Results/INSEE_just_Text_2020.xlsx",
  sheetName = "prevision", rowNames = FALSE
) # 4
...
write.xlsx(df_final_BDF,
  file = "Final_Results/BDF_excel_error_2020.xlsx",
  sheetName = "prevision", rowNames = FALSE
) # 3

write.xlsx(df_final_INSEE,
  file = "Final_Results/INSEE_excel_error_2020.xlsx",
  sheetName = "prevision", rowNames = FALSE
) # 4
...
write.xlsx(df_final_BDF,
  file = "Final_Results/BDF_rolling_text_2020.xlsx",
  sheetName = "prevision", rowNames = FALSE
) # 3

write.xlsx(df_final_INSEE,
  file = "Final_Results/INSEE_rolling_Text_2020.xlsx",
  sheetName = "prevision", rowNames = FALSE
) # 4
